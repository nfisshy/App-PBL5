...
Future<void> _onConfirmDelete(
  ...
  final keepCount = cubit.state.keepCount;

  final deleteCount = cubit.state.pendingDeletes.length;
  ...
  if (ok) {
    /// update all-time
    await cubit.addSavedBytes(savedBytes);

    final totalSavedBytes = cubit.state.totalSavedBytes;
